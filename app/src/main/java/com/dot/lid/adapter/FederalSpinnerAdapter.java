...
public class FederalSpinnerAdapter extends ArrayAdapter<Integer> {
    public FederalSpinnerAdapter(@NonNull Context context, @NonNull Integer[] objects) {
    ...
    public View getDropDownView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (resource > 0) {
            ...
            name.setText(resource);
            if (position == TrainingActivity.FEDERAL_CURRENT_POSITION) {
