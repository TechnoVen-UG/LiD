...
public class SocietySpinnerAdapter extends ArrayAdapter<Integer> {
    public SocietySpinnerAdapter(@NonNull Context context, @NonNull Integer[] objects) {
    ...
    public View getDropDownView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (resource > 0) {
            ...
            name.setText(resource);
            if (position == TrainingActivity.SOCIETY_CURRENT_POSITION) {
