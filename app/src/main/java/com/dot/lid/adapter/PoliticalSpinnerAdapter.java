...
public class PoliticalSpinnerAdapter extends ArrayAdapter<Integer> {
    public PoliticalSpinnerAdapter(@NonNull Context context, @NonNull Integer[] objects) {
    ...
    public View getDropDownView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (resource > 0) {
            ...
            name.setText(resource);
            if (position == TrainingActivity.POLITICAL_CURRENT_POSITION) {
